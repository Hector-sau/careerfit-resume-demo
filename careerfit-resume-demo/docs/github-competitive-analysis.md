...
| [AmruthPillai/Reactive-Resume](https://github.com/AmruthPillai/Reactive-Resume) | 开源简历生成器 | 实时预览、模板、PDF/JSON/DOCX 导出、隐私与自托管 | 强调 privacy-first、无追踪、无隐藏成本，用户信任感强 | 我们的小红书/GitHub 介绍也要突出“不收集隐私、不上传完整简历” |
